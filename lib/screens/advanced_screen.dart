...
class AdvancedScreen extends StatefulWidget {
  static const id = 'advanced_screen';
          ...
          child: ListView(
            children: <Widget>[
              PackCard(
                ...
                cardChild: Text(
                  "Want to build core strength and improve conditioning and flexibility",
                  style: TextStyle(
              ...
              PackCard(
                ...
                colour: kCardColor,
                cardChild: Text(
                  "Want to build lean muscles, core strength, improve conditioning and  flexibility",
                  style: TextStyle(
                    fontFamily: kGoogleFontFamily,
                    fontSize: 25,
                    color: fontColor2,
              ...
              PackCard(
                ...
                colour: kCardColor,
                cardChild: Text(
                  "Want to build muscles, strength, agility, conditioning and flexibility",
                  style: TextStyle(
                    fontFamily: kGoogleFontFamily,
                    fontSize: 25,
                    color: fontColor3,
